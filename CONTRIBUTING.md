Contributing to OmotenashiCoin Core
============================

The OmotenashiCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the OmotenashiCoin Core project, and is not to be
confused with overall OmotenashiCoin Network Protocol consensus changes.

Whether a pull request is merged into OmotenashiCoin Core rests with the project merge
...
Patches that change OmotenashiCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the OmotenashiCoin consensus, it must have been
...
The project leader is the release manager for each OmotenashiCoin Core release.
