...
In order to support loading of multiple wallets in omotenashicoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is omotenashicoin.cpp.
...
Changes to omotenashicoin.cpp
----------------------
omotenashicoin.cpp is the entry point into omotenashicoin-qt, and as such, will require some minor modifications to provide hooks for
