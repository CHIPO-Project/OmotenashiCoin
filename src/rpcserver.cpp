...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop OMOTENASHICOIN server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "OMOTENASHICOIN server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* OmotenashiCoin features */
        {"omotenashicoin", "masternode", &masternode, true, true, false},
        {"omotenashicoin", "listmasternodes", &listmasternodes, true, true, false},
        {"omotenashicoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"omotenashicoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"omotenashicoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"omotenashicoin", "masternodedebug", &masternodedebug, true, true, false},
        {"omotenashicoin", "startmasternode", &startmasternode, true, true, false},
        {"omotenashicoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"omotenashicoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"omotenashicoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"omotenashicoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"omotenashicoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"omotenashicoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"omotenashicoin", "mnbudget", &mnbudget, true, true, false},
        {"omotenashicoin", "preparebudget", &preparebudget, true, true, false},
        {"omotenashicoin", "submitbudget", &submitbudget, true, true, false},
        {"omotenashicoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"omotenashicoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"omotenashicoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"omotenashicoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"omotenashicoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"omotenashicoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"omotenashicoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"omotenashicoin", "checkbudgets", &checkbudgets, true, true, false},
        {"omotenashicoin", "mnsync", &mnsync, true, true, false},
        {"omotenashicoin", "spork", &spork, true, true, false},
        {"omotenashicoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"omotenashicoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
{
    return "> omotenashicoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:12180/\n";
}
