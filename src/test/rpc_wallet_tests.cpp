...
printf( "result : %s\n",setaccountDemoAddress.ToString().c_str()) ; // kaniTODO
    ...
    /* wrong address */
    BOOST_CHECK(CallRPC("verifymessage MiUCBYShHUTbotBn1J2PNRjSWjDU8m6oPP " + retValue.get_str() + " mymessage").get_bool() == false);
