...
static const string strSecret1     ("72bznwyHU9yqSwtNg2HXRFSKeH4NyVX44FDWNgpHFYRHAYuy8g4");
static const string strSecret2     ("724HaZfDyqn1msx4iZyorFRQ9kVBv6bCKEjCPk3dFiFAUJns9kE");
static const string strSecret1C    ("TarYd7VQRYDjxcFvBA2inLGMk5SB5g7kJHz2f1Az5rxdfE6nFZnQ");
static const string strSecret2C    ("TZTtn59VNcuBhSvNexCL14WcwccDqAPG154Pp9yLMeihZ6un6A6i");
static const CBitcoinAddress addr1 ("MtBDZd7szkn5sDowa1c1aSNtTFjNqnvHkq");
static const CBitcoinAddress addr2 ("MZgH6UB3eoWVzs22ChCDyZKAB7HuQMRi38");
static const CBitcoinAddress addr1C("MsPGNg5sY4Qv2WGur24eBdQ2KFWWx5BXF6");
static const CBitcoinAddress addr2C("MnEqK2gpBfeV7GJeKWRzPkQyiwW2AdipaE");
...
void dumpKeyInfo(uint256 privkey)
{
    ...
    for (int nCompressed=0; nCompressed<2; nCompressed++)
    {
        ...
        //bool fGood = vchSecret.SetString(strSecret1);
        //bool fGood = vchSecret.SetString(strSecret2);
        //bool fGood = vchSecret.SetString(strSecret1C);
        bool fGood = vchSecret.SetString(strSecret2C);

        CKey key = vchSecret.GetKey();

        key.Set(key.begin(), key.end(), fCompressed ? 1 : 0);
