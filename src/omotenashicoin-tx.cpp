...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("OmotenashiCoin Core omotenashicoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  omotenashicoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded omotenashicoin transaction") + "\n" +
                               "  omotenashicoin-tx [options] -create [commands]   " + _("Create hex-encoded omotenashicoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded omotenashicoin transaction
