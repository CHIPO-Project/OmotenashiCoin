...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("OmotenashiCoin Core"),
     ...
     * override -datadir in the omotenashicoin.conf file in the default data directory
     * (to be consistent with omotenashicoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
