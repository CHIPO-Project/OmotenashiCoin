...
/** Utility functions used by the OmotenashiCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render OmotenashiCoin addresses in monospace font
...
// Parse "omotenashicoin:" URI into recipient object, return true on successful parsing
