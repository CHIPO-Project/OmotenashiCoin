...
#define URI_SCHEME "omotenashicoin"
...
void setupAddressWidget(QValidatedLineEdit* widget, QWidget* parent)
{
    ...
    widget->setPlaceholderText(QObject::tr("Enter a OmotenashiCoin address (e.g. %1)").arg("MgnLAZPGwnFudGDXdMaig4pQy9bsydvDds"));
#endif
...
{
    // return if URI is not valid or is no OmotenashiCoin: URI
...
{
    // Convert omotenashicoin:// to omotenashicoin:
    //
    //    Cannot handle this later, because omotenashicoin:// will cause Qt to see the part after // as host,
...
void openConfigfile()
{
    ...
    /* Open omotenashicoin.conf with the associated application */
...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "OMOTENASHICOIN.lnk";
}

bool GetStartOnSystemStartup()
{
    // check for OmotenashiCoin.lnk
...
{
    return GetAutostartDir() / "omotenashicoin.desktop";
}
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    if (!fAutoStart)
        ...
        if (!optionFile.good())
            return false;
        // Write a omotenashicoin.desktop file to the autostart directory:
        optionFile << "[Desktop Entry]\n";
        optionFile << "Type=Application\n";
        optionFile << "Name=OMOTENASHICOIN\n";
...
LSSharedFileListItemRef findStartupItemInList(LSSharedFileListRef list, CFURLRef findUrl)
{
    // loop through the list of startup items and try to find the omotenashicoin app
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    ...
    if (fAutoStart && !foundItem) {
        // add omotenashicoin app to startup item list
