                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("OmotenashiCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a OmotenashiCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and omotenashicoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About OmotenashiCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about OmotenashiCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for OmotenashiCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your OmotenashiCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified OmotenashiCoin addresses"));
	...
	*/
    ...
    openAction->setStatusTip(tr("Open a OmotenashiCoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the OmotenashiCoin Core help message to get a list with possible OmotenashiCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("OmotenashiCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to OmotenashiCoin network", "", count));
}
...
{
    QString strTitle = tr("OmotenashiCoin Core"); // default title
    ...
    // Append title to "OmotenashiCoin - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
