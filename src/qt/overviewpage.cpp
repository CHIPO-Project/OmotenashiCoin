...
//        automintHelp += tr("To disable AutoMint add 'enablezeromint=0' in omotenashicoin.conf.");
//    }
//    else {
//        automintHelp += tr("AutoMint is currently disabled.\nTo enable AutoMint change 'enablezeromint=0' to 'enablezeromint=1' in omotenashicoin.conf");
//    }
